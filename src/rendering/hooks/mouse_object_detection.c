...
/*   Updated: 2025/04/26 16:30:38 by mtohmeh          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../include/miniRT.h"

static void	detect_sphere(t_ray ray, t_scene *scene, object_info *obj,
		float *closest_t)
{
	t_sphere	*sphere;
	float		t_sphere;
...
static void	detect_plane(t_ray ray, t_scene *scene, object_info *obj,
		float *closest_t)
{
	t_plane	*plane;
	float	t_plane;
...
static void	detect_cylinder(t_ray ray, t_scene *scene, object_info *obj,
		float *closest_t)
{
	t_cylinder	*cylinder;
	float		t_cylinder;
